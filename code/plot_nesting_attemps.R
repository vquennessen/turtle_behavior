...
nests2 <- nests %>%
  ...
  mutate(day = yday(date), 
         year = year(date), 
         season = ifelse(date < '2015-06-01 00:00', '2015 Season ', 
                         ifelse(date < '2016-06-01 00:00', '2016 Season ', 
                                ifelse(date < '2017-06-01 00:00', '2017 Season', 
                                       ifelse(date < '2018-06-01 00:00', '2018 Season',
                                       '2019 Season')))))
